          ...
          <div className="flex items-center justify-center min-h-screen bg-background">
            <div className="flex flex-col items-center gap-8 max-w-sm text-center px-6">
              ...
              <SignInButton mode="modal">
                <button
                  type="button"
                  className="flex items-center gap-2 bg-slate-900 hover:bg-slate-800 dark:bg-slate-100 dark:hover:bg-slate-200 text-white dark:text-slate-900 text-sm font-medium px-6 py-3 rounded-full cursor-pointer transition-colors duration-200 shadow-md hover:shadow-lg active:scale-[0.98]"
                >
